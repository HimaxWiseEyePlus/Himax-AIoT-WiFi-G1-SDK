...
.SECONDEXPANSION:
$(APPL_FULL_NAME).elf : $(ALL_GENERATED_DIRS_TMPFILES) $(CORE_ARG_FILES) $(APPL_LINK_FILE) $(APPL_OBJS) $(EXTRA_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(SCENARIO_APP_OBJS) $(EVENTHANDLER_OBJS) $(EMBARC_LIB) $(OKAO_LIB) $(BOARD_OPEN_LIB_SOCKET) $(CV_LIB) $(BSS_LIB) $(MLI_LIB) $(SECURE_LIB) $(AUDIO_ALGO_LIB) $(ALANGO_ALGO_LIB) $(GNU_DEP_LIB) $$(COMMON_COMPILE_PREREQUISITES)
	$(TRACE_LINK)
	$(Q)$(LD) $(LINK_OPT) $(APPL_OBJS) $(EXTRA_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(SCENARIO_APP_OBJS) $(EVENTHANDLER_OBJS) $(LD_START_GROUPLIB) $(EMBARC_LIB) $(OKAO_LIB) $(BOARD_OPEN_LIB_SOCKET) $(CV_LIB) $(BSS_LIB) $(MLI_LIB) $(SECURE_LIB) $(AUDIO_ALGO_LIB) $(ALANGO_ALGO_LIB) $(GNU_DEP_LIB) $(APPL_LIBS) $(LD_SYSTEMLIBS) $(LD_END_GROUPLIB) -o $@
...
ifeq ($(IC_PACKAGE_SEL), LQFP128)
	$(CP) .\library\prebuilt_lib\libembarc_128pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), WLCSP38)
	$(CP) .\library\prebuilt_lib\libembarc_38pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
...
ifeq ($(IC_PACKAGE_SEL), QFN72)
	$(CP) .\library\prebuilt_lib\libembarc_72pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif	
else
ifeq ($(IC_PACKAGE_SEL), LQFP128)
ifeq ($(TOOLCHAIN), mw)
...
ifeq ($(IC_PACKAGE_SEL), QFN72)
ifeq ($(TOOLCHAIN), mw)	
	$(CP) ./library/rebuilt_lib/libembarc_72pin.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
else	
ifeq ($(OS_TYPE), )
...
ifeq "$(HOST_OS)" "Windows"
ifeq ($(IC_PACKAGE_SEL), LQFP128)
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a .\library\prebuilt_lib\libembarc_128pin.a
endif
ifeq ($(IC_PACKAGE_SEL), WLCSP38)
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a .\library\prebuilt_lib\libembarc_38pin.a
endif
ifeq ($(IC_PACKAGE_SEL), QFP100)
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a .\library\prebuilt_lib\libembarc_100pin.a
endif	
ifeq ($(IC_PACKAGE_SEL), QFN72)
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a .\library\prebuilt_lib\libembarc_72pin.a
endif
else
ifeq ($(IC_PACKAGE_SEL), LQFP128)
ifeq ($(TOOLCHAIN), mw)	
