...
##
	COMMON_COMPILE_OPT += -ffixed-gp
	COMPILE_OPT += -D__Xdmac -Os
	CXX_COMPILE_OPT += -mxy -mcpu=em4_fpus
	CXX_COMPILE_OPT += -mlittle-endian \
					   -mcode-density \
					   -mdiv-rem \
					   -mswap \
					   -mnorm \
