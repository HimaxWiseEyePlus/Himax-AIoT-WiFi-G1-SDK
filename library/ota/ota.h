...
typedef enum
{
	...
	OTA_ERROR_CHECKSUM						,
	OTA_ERROR_FLASH_ADDR					,
	OTA_ERROR_INVALID_PARA					,	
	OTA_ERROR_GET_DATA_FAIL					,	
	OTA_ERROR_WRONG_DATA_LENGTH				,
	OTA_ERROR_STEP_FAIL						,
	OTA_NO_MEMORY_DESCRYPTOR                ,
	OTA_ERROR_UNKNOWN							
} OTA_ERROR_E;

typedef enum
{
	OTA_STATUS_GET_SYS_VERSION				= 0	,	
	OTA_STATUS_GET_SYS_PROJECT_ID				,
	OTA_STATUS_OTA_INIT							,	
	OTA_STATUS_OTA_RECEIVE_UPGRADE_DATA			,	
	OTA_STATUS_OTA_END							,
	OTA_STATUS_OTA_SENT_RESULT					,
	OTA_STATUS_OTA_ABORT						,
	OTA_STATUS_OTA_EIP130_INIT					,	
	OTA_STATUS_OTA_DATA_VERIFY					,	
	OTA_STATUS_OTA_FLASH_INIT					,	
	OTA_STATUS_OTA_FLASH_BURN					,	
	OTA_STATUS_OTA_FLASH_READ					,	
