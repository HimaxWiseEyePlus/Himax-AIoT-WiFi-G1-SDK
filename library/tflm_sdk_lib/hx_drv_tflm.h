...
typedef enum __attribute__((packed))
{
	HX_DRV_I2C_Action_W = 0,             /**< I2C Master Write operation */
	HX_DRV_I2C_Action_R,                 /**< I2C Master Read operation */
	HX_DRV_I2C_Action_S,                 /**< CPU Delay in ms, wait operation */
}HX_DRV_I2C_ActionType_E;
...
typedef struct {
	HX_DRV_I2C_ActionType_E I2C_ActionType;/**< CIS Sensor I2C Master Action Write, Read, Delay operation */
    uint16_t RegAddree; /**< register address for I2C Master if I2C_ActionType == HX_CIS_I2C_Action_S, RegAddree = delay msec */
    uint8_t Value;/**< register value for I2C Master if I2C_ActionType == HX_CIS_I2C_Action_S, don't care and left it with 0 */
} __attribute__((packed)) hx_drv_SensorSetting_t;

typedef void (*CALLBACK_FRAME_FUNC) (uint32_t raw_address, uint32_t raw_size, uint32_t jpeg_address, uint32_t jpeg_size);
/****************************************************
...
/**
 * \brief	initial flash and set to XIP mode
 *
 *
 * \retval	HX_DRV_LIB_PASS		Operation success
 * \retval	HX_DRV_LIB_ERROR	Operation fail
 ...
 * \retval	HX_DRV_LIB_ERROR	Operation fail
 */
extern void* hx_drv_flash_get_Model_address();
