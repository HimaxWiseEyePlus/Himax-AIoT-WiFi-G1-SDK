...
/**
 * \brief	jpeg swreset 1: start SW Reset, 0: stop SW RESET
 *
 * \param[in]	swreset	 1: start SW Reset, 0: stop SW RESET
 * \return	JPEG_ERROR_E.
 */
JPEG_ERROR_E hx_drv_jpeg_swreset(uint8_t swreset);
/** @} */
