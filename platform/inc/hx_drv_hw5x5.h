 ...
 */
HW5x5_ERROR_E hx_drv_hw5x5_init();
 ...
 * \return	HW5x5_ERROR_E.
 */
HW5x5_ERROR_E hx_drv_hw5x5_get_available_HV(HW5x5_PATH_E path, DEMOS_BNDODE_E bndmode, uint16_t in_width,uint16_t in_height,uint16_t *crop_width,uint16_t *crop_height);
 ...
 * \return	HW5x5_ERROR_E.
 */
HW5x5_ERROR_E hx_drv_hw5x5_set_crop(uint16_t crop_stx,uint16_t crop_sty, uint16_t crop_width, uint16_t crop_height);
 ...
 * \return	HW5x5_ERROR_E.
 */
HW5x5_ERROR_E hx_drv_hw5x5_get_crop(uint16_t *crop_stx,uint16_t *crop_sty, uint16_t *crop_width, uint16_t *crop_height);
 ...
 * \return	HW5x5_ERROR_E.
 */
HW5x5_ERROR_E hx_drv_hw5x5_get_OutMEMSize(HW5x5_CFG_T hw55_cfg, uint32_t *ch1_mem_size, uint32_t *ch2_mem_size,uint32_t *ch3_mem_size);
/** @} */
#endif
