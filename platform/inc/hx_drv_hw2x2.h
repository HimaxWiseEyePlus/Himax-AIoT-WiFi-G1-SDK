 ...
 */
HW2x2_ERROR_E hx_drv_hw2x2_init();
 ...
 * \return	HW2x2_ERROR_E.
 */
HW2x2_ERROR_E hx_drv_hw2x2_get_available_HV(HW2x2_MODE_E scale, uint16_t in_width,uint16_t in_height,uint16_t *crop_width,uint16_t *crop_height);
 ...
 * \return	HW2x2_ERROR_E.
 */
HW2x2_ERROR_E hx_drv_hw2x2_set_crop(uint16_t crop_stx,uint16_t crop_sty, uint16_t crop_width, uint16_t crop_height);
 ...
 * \return	HW2x2_ERROR_E.
 */
HW2x2_ERROR_E hx_drv_hw2x2_get_crop(uint16_t *crop_stx,uint16_t *crop_sty, uint16_t *crop_width, uint16_t *crop_height);
 ...
 * \return	HW2x2_ERROR_E.
 */
HW2x2_ERROR_E hx_drv_hw2x2_get_OutMEMSize(HW2x2_CFG_T hw2x2_cfg, uint32_t *mem_size);
/** @} */
#endif
