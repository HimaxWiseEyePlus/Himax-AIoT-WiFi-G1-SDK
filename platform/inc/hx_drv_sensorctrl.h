 ...
 * Ex5: set WLCSP38 share pin type for Sensor HM11B1 or HM01B0
 * 		hx_drv_sensorctrl_set_wlcsp_sharepin(SENSORCTRL_WLCSP_SHAREPIN_E type);
 * </pre>
 */
/**
...
typedef enum
{
	SENSORCTRL_OPMODE_HM11B1_LOW_POWER	 			= 0,/**<HW Trigger Low power mode ¡V HM11B1*/
	SENSORCTRL_OPMODE_HM01B0_CONTINUOUS 			= 1,/**<HW Trigger Continuous mode ¡V HM01B0*/
	SENSORCTRL_OPMODE_HM0360_CONTINUOUS 			= 2,/**<HW Trigger Continuous mode ¡V HM0360 Oscillator version*/
	SENSORCTRL_OPMODE_HM0360_BURST		 			= 3,/**<HW Trigger Burst mode ¡V HM0360 Oscillator version*/
	SENSORCTRL_OPMODE_HM0360_AUTOWAKEUP_SENACTIVE	= 4,/**<Automatic wake-up mode(sensor active) ¡V HM0360 Oscillator version*/
	SENSORCTRL_OPMODE_HM0360_AUTOWAKEUP_WE1ACTIVE	= 5,/**<Automatic wake-up mode(WE-I ACTIVE) ¡V HM0360 Oscillator/MCLK version*/
	SENSORCTRL_OPMODE_HM0360_CONTINUOUS_WIHMCLK 	= 6,/**<HW Trigger Continuous mode ¡V HM0360 MCLK version*/
	SENSORCTRL_OPMODE_HM0360_BURST_WITHMCLK		 	= 7,/**<HW Trigger Burst mode ¡V HM0360 MCLK version*/
} SENSORCTRL_OPMODE_E;
 ...
 */
SENSORCTRL_ERROR_E hx_drv_sensorctrl_init();
 ...
 * \return	SENSORCTRL_ERROR_E.
 */
SENSORCTRL_ERROR_E hx_drv_sensorctrl_set_xShutdown(IOMUX_INDEX_E gpio, uint8_t high);
...
/**
 * \brief	set WLCSP38 share pin type for Sensor HM11B1 or HM01B0 or HM0360 MCLK(VerC Support) or HM0360 OSC(VerC Support)
 *
 * \param[in]	type	 WLCSP38 share pin type
 * \return	SENSORCTRL_ERROR_E.
 */
SENSORCTRL_ERROR_E hx_drv_sensorctrl_set_wlcsp_sharepin(SENSORCTRL_WLCSP_SHAREPIN_E type);
