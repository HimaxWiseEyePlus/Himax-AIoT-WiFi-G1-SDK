...
#if defined(HM0435_QVGA)
    #define IMAG_SZ (320*240)
#elif defined(HM0435) //VGA
    #define IMAG_SZ (640*480)
#endif
#define YUV_PLANAR_BASE_ADDR    ((0x20020800) + (IMAG_SZ * 2))
#define YUV_PLANAR_Y_ADDR       (YUV_PLANAR_BASE_ADDR + 0)
#define YUV_PLANAR_U_ADDR       (YUV_PLANAR_Y_ADDR + IMAG_SZ)
#define YUV_PLANAR_V_ADDR       (YUV_PLANAR_U_ADDR + (IMAG_SZ >> 1))
