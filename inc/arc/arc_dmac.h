...
extern void _dma_chan_trigger(unsigned int mask);
extern void _dma_channel_status0(unsigned int *status);
extern void _dma_channel_status1(unsigned int *status);
extern void _dma_channel_clear(unsigned int mask);
